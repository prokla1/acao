...
include_once "/js/ckeditor/ckfinder/plugins/imageresize/plugin.php";
include_once "/js/ckeditor/ckfinder/plugins/fileeditor/plugin.php";
include_once "/js/ckeditor/ckfinder/plugins/zip/plugin.php";
