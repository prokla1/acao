...
--
-- Servidor: localhost
-- Tempo de Geração: 16/10/2013 às 00:01:49
...
INSERT INTO `eventos` (`id`, `url_amigavel`, `id_parceiro`, `id_endereco`, `id_cidade`, `endereco`, `complemento`, `nome`, `descricao`, `capa`, `ativo`, `destaque`, `realizacao`, `hora`) VALUES
(2, 'teste-07-03-2013', 11, 1, 2, NULL, NULL, 'Teste', '<p>teste</p>\r\n', 'evento_51378f5b05f28.png', '1', '0', '2013-05-25', '2013-03-06 18:47:55'),
(3, 'teste-de-evento-no-westbar-08-03-2013', 12, 2, 1, NULL, NULL, 'Teste de evento no WestBar', '<p>teste-de-evento-no-westbar-08-03-2013</p>\r\n', 'null.jpg', '1', '0', '2013-05-25', '2013-03-07 17:15:02'),
(5, 'joao-lucas-e-marcelo-rodrigo-vasslentin-08-03-2013', 9, 5, 1, NULL, NULL, 'João Lucas e Marcelo  + Rodrigo Valentin', '<p>joao-lucas-e-marcelo-rodrigo-vasslentin-08-03-2013</p>\r\n\r\n\r\nNa cervejaria Original em Sào Jose', 'null.jpg', '1', '0', '2013-05-25', '2013-03-21 20:44:10'),
(6, 'teste-de-evento-no-westbarsad-fas-08-03-2013', 8, 2, 1, NULL, NULL, 'Teste de evento no WestBarsad fas ', '<p>sad fas&nbsp;</p>\r\n', 'null.jpg', '1', '0', '2013-05-25', '2013-03-07 20:13:30');
...
CREATE TABLE IF NOT EXISTS `pagamento_formas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) NOT NULL,
  `imagem` varchar(255) NOT NULL,
  `troco` enum('0','1') NOT NULL DEFAULT '0',
  `descricao` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=16 ;

--
-- Extraindo dados da tabela `pagamento_formas`
--

INSERT INTO `pagamento_formas` (`id`, `nome`, `imagem`, `troco`, `descricao`) VALUES
(1, 'Dinheiro', 'dinheiro.png', '1', 'Pagamento a vista em dinheiro diretamente para o entregador'),
(2, 'Visa', 'visa.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(3, 'Visa Electron', 'visaelectron.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(4, 'MasterCard', 'mastercard.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(5, 'Maestro', 'maestro.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(6, 'Diners', 'diners.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(7, 'Hipercard', 'hipercard.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(8, 'Aura', 'aura.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(9, 'Elo', 'elo.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(10, 'American Express', 'amex.png', '0', 'Estabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido.'),
(11, 'Cirrus', 'cirrus.png', '0', 'Estabelecimento leva a máquina até o cliente no momento da entrega'),
(12, 'Delta', 'delta.png', '0', 'Estabelecimento leva o cartão até o cliente'),
(13, 'GoodCard', 'goodcard.png', '0', 'stabelecimento envia a máquina de cartão, o pagamento é processado no momento da entrega do pedido'),
(14, 'Cheque', 'cheque.png', '0', NULL),
(15, 'Visa Vale', 'visavale.png', '0', 'Estabelecimento leva a máquina de cartão até o cliente');
...
(88, 11, '201305161131475194edd360829.png');

-- --------------------------------------------------------

--
-- Estrutura da tabela `parceiros_pagamento`
--

DROP TABLE IF EXISTS `parceiros_pagamento`;
CREATE TABLE IF NOT EXISTS `parceiros_pagamento` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parceiro` int(11) NOT NULL,
  `pagamento` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `estabeleciimento` (`parceiro`),
  KEY `pagamento` (`pagamento`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=41 ;

--
-- Extraindo dados da tabela `parceiros_pagamento`
--

INSERT INTO `parceiros_pagamento` (`id`, `parceiro`, `pagamento`) VALUES
(34, 11, 10),
(35, 11, 1),
(37, 11, 5),
(38, 11, 4),
...
(1, '127.0.0.1', 11, '2013-03-21 04:35:49'),
(2, '127.0.0.1', 11, '2013-10-12 00:05:17');
...
CREATE TABLE IF NOT EXISTS `rel_atividade_parceiro` (
  ...
  `hora` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_parceiro_2` (`id_parceiro`,`id_atividade`),
  KEY `id_parceiro` (`id_parceiro`),
...
(54, 11, 4, '1', '2013-05-16 14:30:46'),
(56, 8, 6, '1', '2013-05-16 14:38:20'),
(57, 11, 1, '1', '2013-05-22 20:36:39'),
(59, 11, 7, '1', '2013-05-22 20:36:39'),
(62, 11, 2, '1', '2013-10-12 00:00:07');

-- --------------------------------------------------------

--
-- Estrutura da tabela `rel_evento_banda`
--

DROP TABLE IF EXISTS `rel_evento_banda`;
CREATE TABLE IF NOT EXISTS `rel_evento_banda` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_evento` int(11) NOT NULL,
...
--
-- Restrições para a tabela `credenciais`
--
...
ALTER TABLE `eventos`
  ...
  ADD CONSTRAINT `eventos_ibfk_5` FOREIGN KEY (`id_cidade`) REFERENCES `local_cidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `parceiros`
  ...
  ADD CONSTRAINT `parceiros_ibfk_5` FOREIGN KEY (`id_cidade`) REFERENCES `local_cidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Restrições para a tabela `parceiros_pagamento`
--
ALTER TABLE `parceiros_pagamento`
  ADD CONSTRAINT `parceiros_pagamento_ibfk_1` FOREIGN KEY (`parceiro`) REFERENCES `parceiros` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `parceiros_pagamento_ibfk_2` FOREIGN KEY (`pagamento`) REFERENCES `pagamento_formas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
